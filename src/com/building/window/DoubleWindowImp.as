package com.building.window {
	...
	public class DoubleWindowImp implements DoubleWindow {
		...
		public function DoubleWindowImp(target:MovieClip, pane1:WindowPane, pane2:WindowPane, topShutter:Shutter, leftShutter:Shutter, random:RandomBooleanGenerator, shutterSwitcher:ShutterSwitcher = null):void {
			_target = target;
			_pane1 = pane1
			_pane2 = pane2
